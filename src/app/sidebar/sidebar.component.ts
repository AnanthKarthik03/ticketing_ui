...
export class SidebarComponent implements OnInit {
  ...
  role() {
    this.routers.navigate(['/role']);
  }
  employeeDashboard() {
    this.routers.navigate(['/employeeDashboard']);
  }
  adminDashboard() {
    this.routers.navigate(['/adminDashboard']);
  }
  clientDashboard() {
    this.routers.navigate(['/clientDashboard']);
  }
  projectManager() {
    this.routers.navigate(['/pmDashboard']);
  }
  project() {
    this.routers.navigate(['/projects']);
  }
  projectReport() {
    this.routers.navigate(['/projectReport']);
  }

  timeSheetReport() {
    this.routers.navigate(['/timeSheetReport']);
  }

  clientReport() {
    this.routers.navigate(['/clientReport']);
  }

  ticketingDetails() {
    this.routers.navigate(['/ticketingDetails']);
  }
  employeeReport() {
    this.routers.navigate(['/employeeReport']);
  }
  timeSheet() {
  ...
  summaryReports() {
    this.routers.navigate(['/summaryReports']);
  }
